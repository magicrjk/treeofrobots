...
def main():
    print('in main:')
    print(os.getcwd())
    print(os.path.join("FlaskWebsite","modules","classification","files_structure.yaml"))
    with open(os.path.join("FlaskWebsite","modules","classification","files_structure.yaml"), 'r') as file:
    ...
    for class_name,items in files_struct.items():
        datapath = os.path.join(os.path.normpath(os.path.join(os.path.dirname(__file__), '..', '..', 'uploads', 'new_robot')),class_name) #path files of the user
